...
<body>
  <div class="container">
    <div class="row row1">
      <h1 class="text-center"><b>클래스하루 채팅</b></h1>
      <table class="table" style="border-radius: 8px">
       <tr>
        <td>
         <input type=button id="startBtn" value="입장" class="btn btn-sm btn-default" data-name="${sessionScope.mvo.name }">
         <input type=button id="endBtn" value="퇴장" class="btn btn-sm btn-default">
         <a href="../main/main.do" class="btn btn-sm btn-default">메인</a>
        </td>
       </tr>
       <tr>
         <td>
	         <div id="chatArea" style="border-radius: 8px">
	           <div id="recvMsg"></div>
	         </div>
         </td>
       </tr>
       <tr>
         <td>
           <input type="text" id="sendMsg" size=80 class="input-sm" style="border-radius: 8px">
           <input type=button id="sendBtn" value="전송" class="btn btn-sm btn-default">
         </td>
       </tr>
      </table>
    </div>
